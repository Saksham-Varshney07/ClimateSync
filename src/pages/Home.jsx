        ...
        <div className="hero-container">
          <div className="hero-content">
            ...
            <div className="hero-buttons">
              ...
              <Link
                ...
                style={{ color: 'black', borderColor: 'rgba(255,255,255,0.3)' }}
              >
                View Dashboard
              </Link>
          ...
          <div className="hero-visual">
            ...
            >
              ...
              {/* Data waves */}
              <path
                d="M50 320 Q100 280, 150 320 T250 320 T350 320 T450 320"
                stroke="#38BDF8"
                strokeWidth="3"
                fill="none"
                opacity="0.5"
              ...
              <path
                d="M50 340 Q100 310, 150 340 T250 340 T350 340 T450 340"
                stroke="#38BDF8"
                strokeWidth="2"
                fill="none"
                opacity="0.3"
        ...
        <div className="container">
          ...
          <div className="why-cards">
            {whyCards.map((card, index) => (
              <div
                key={index}
                className="why-card animate-fade-in-up"
        ...
        <div className="container">
          ...
          <div className="cta-card">
            ...
            <Link
              to="/dashboard"
              className="btn btn-primary"
              title="Explore the heatwave monitoring dashboard"
            >
